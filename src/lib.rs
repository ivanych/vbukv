...
//! # DESCRIPTION
//!
//! Пакет [vbukv](crate) содержит библиотеку [vbukv::libvbukv](libvbukv) для поиска слов
//! в словаре по буквам.
//! Также в пакете есть консольное приложение **vbukv**,
...
//! командной строки с помощью модуля [vbukv::input::args](input::args):
//!
//! ```
...
//! ```
//!
//! Библиотека [vbukv::libvbukv](libvbukv) не накладывает ограничений на источник параметров.
...
//! с помощью модуля [vbukv::output::term](output::term):
//!
//! ```
...
//! ```
//!
//! Библиотека  [vbukv::libvbukv](libvbukv) не имеет средств вывода,
