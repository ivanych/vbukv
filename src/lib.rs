...
//!
//! Например, консольное приложение [vbukv](../vbukv_cli/index.html) получает
//! параметры из аргументов командной строки с помощью модуля [input::args].
//!
//! ## Вывод результата
//!
//! Для вывода результатов используются различные методы из модулей [output].
//!
//! Например, консольное приложение [vbukv](../vbukv_cli/index.html) выводит
//! результат в терминал с помощью модуля [output::term].
